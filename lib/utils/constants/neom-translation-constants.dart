...
class NeomTranslationConstants {
  ...
  static const List<dynamic> locales = [
    {'name': 'English', 'locale': Locale('en', 'US')},
    {'name': 'Español', 'locale': Locale('esp', 'MX')},
    {'name': 'German', 'locale': Locale('de', 'DE')},
    {'name': 'French', 'locale': Locale('fr', 'FR')}
  ];

  static const List<Locale> supportedLocales = [
    Locale('en', 'US'), Locale('esp', 'MX'),
  ...
  static const String loadingNeomGenerator = "loadingNeomGenerator";
  static const String frequencyGenerator = "frequencyGenerator";

  static const String neomSession = "neomSession";
  static const String letsOm = "letsOm";
  static const String savePreset = "savePreset";
  static const String save = "save";

  static const String presetDetailsAddedMsg = "presetDetailsAddedMsg";
  static const String addToYourChamber = "addToYourChamber";
  static const String removeFromChamber = "removeFromChamber";
  static const String chamberPrefs = 'chamberPrefs';

  static const String cantRemoveMainChamber = "cantRemoveMainChamber";

  static const String createNeomChamber = "createNeomChamber";
  static const String addChamber = "addChamber";

  static const String neommates = "neommates";
  static const String neommateSearch = "neommateSearch";
  ...
  static const String onTapCoverChange = "Would you like to change your cover image? Donate to my paypal account. Thanks for using this app!!!";
  static const String onTapPhotoChange = "Would you like to change your profile picture? Give me a chance to get some time and implement this feature!! Also, you could donate to my paypal account. Thanks for using this app!!!";
  static const String onTapProfileEdit = "Would you like to edit your profile info? Working on it";
  ...
  static const String defaulScaleDegree = "defaultScaleDegree";
  static const String frequencyPreferences = "frequencyPreferences";
  static const String selectedAsRootFrequency = "selectedAsRootFrequency";
  ...
  static const String welcomeToCyberneom = 'welcomeToCyberneom';
  ...
  static const String neommatesMsg = 'neommatesMsg';
  ...
  static const String searchPostProfileNeommates = 'searchPostProfileNeommates';
